...
export default async (request, context) => {
  try {
    ...
    if (request.method === "GET") {
      ...
      // Home hero: always serve the currently saved hero image from one stable URL.
      // no-store is intentional: after an admin changes the hero, a cold load must never
      // paint an older browser/CDN copy first.
